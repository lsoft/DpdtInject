...
namespace DpdtInject.Binding.Example.Two
{
    ...
    public partial class D2pdt2Module2 : DpdtModule
    {
        ...
        public T Get<T>()
        {
            return ((IBaseProvider<T>)_provider).Get(ResolutionContext.EmptyContext);
        }


        public List<T> GetAll<T>()
        {
            return ((IBaseProvider<T>)_provider).GetAll(ResolutionContext.EmptyContext);
        }

        public interface IBaseProvider<T>
        {
            T Get(ResolutionContext resolutionContext);

            List<T> GetAll(ResolutionContext resolutionContext);
        }
            ...
            IBaseProvider<IB>
        {
            ...
            IA IBaseProvider<IA>.Get(ResolutionContext resolutionContext)
            {
                if (IA1_IA2_A_Singleton_Container_AC5CC60D_A385_4A7B_A741_4089E650CEB5.CheckPredicate(resolutionContext))
                {
                    return IA1_IA2_A_Singleton_Container_AC5CC60D_A385_4A7B_A741_4089E650CEB5.GetInstance();
                }

                throw new InvalidOperationException($"No binding exists for this request!");
            }
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            List<IA> IBaseProvider<IA>.GetAll(ResolutionContext resolutionContext)
            {
            ...
            //IA IBaseProvider<IA>.GetWithContext()
            //{
            //    if(IA1_IA2_A_Singleton_Container_AC5CC60D_A385_4A7B_A741_4089E650CEB5.CheckPredicate())
            //    {
            //        return IA1_IA2_A_Singleton_Container_AC5CC60D_A385_4A7B_A741_4089E650CEB5.GetInstance();
            //    }
            ...
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            IB IBaseProvider<IB>.Get(ResolutionContext resolutionContext)
            {
                if (IB_B_Singleton_Container_E0C46AC9_14EA_4142_A7D5_17460AA7AB90.CheckPredicate(resolutionContext))
                {
            ...
            //[MethodImpl(MethodImplOptions.AggressiveInlining)]
            List<IB> IBaseProvider<IB>.GetAll(ResolutionContext resolutionContext)
            {
                return
                    new List<IB>
                    {
            ...
            //IB IBaseProvider<IB>.GetWithContext()
            //{
            //    if (IB_B_Singleton_Container_E0C46AC9_14EA_4142_A7D5_17460AA7AB90.CheckPredicate())
            //    {
            //        return IB_B_Singleton_Container_E0C46AC9_14EA_4142_A7D5_17460AA7AB90.GetInstance();
            //    }
        ...
        public sealed class IB_B_Singleton_Container_E0C46AC9_14EA_4142_A7D5_17460AA7AB90
        {
            ...
            {
                if(!IA1_IA2_A_Singleton_Container_AC5CC60D_A385_4A7B_A741_4089E650CEB5.CheckPredicate(
                    resolutionContext.AddFrame(null)
                    ))
                {
                    return false;
                }
