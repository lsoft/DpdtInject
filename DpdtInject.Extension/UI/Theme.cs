...
namespace DpdtInject.Extension.UI
{
    public static class Theme
    {
        private static ResourceDictionary BuildThemeResources()
        {
            ...
            ResourceDictionary comboTheme = (ResourceDictionary)Application.LoadComponent(new Uri("DpdtInject.Extension;component/UI/Control/VsThemedComboBox.xaml", UriKind.Relative));
